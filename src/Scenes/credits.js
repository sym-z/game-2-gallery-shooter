class Credits extends Phaser.Scene
{
    ...
    create() 
    {
        ...
        this.title = this.add.bitmapText(400,150,'pi','Programming: Jack Sims', 64).setOrigin(0.5);
        this.title = this.add.bitmapText(400,300,'pi','Art, Audio and Font: Made by Kenney', 48).setOrigin(0.5);
